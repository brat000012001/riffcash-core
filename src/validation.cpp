...
#if defined(NDEBUG)
# error "Riffcash cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Riffcash Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s RFC additional fees, %d delta bytes\n",
