...
const char * const BITCOIN_CONF_FILENAME = "riffcash.conf";
const char * const BITCOIN_PID_FILENAME = "riffcash.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Riffcash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Riffcash";
#else
    // Unix
    return pathRet / ".riffcash";
#endif
#endif
}
