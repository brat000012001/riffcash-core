...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/riffcash-project/riffcash>";
    const std::string URL_WEBSITE = "<https://riffcash.org>";
