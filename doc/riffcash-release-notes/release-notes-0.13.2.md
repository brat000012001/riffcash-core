Riffcash Core version 0.13.2 is now available from:
  ...
  <https://download.riffcash.org/riffcash-0.13.2.1/>
...
Then, to tunnel a SSL connection on 219764 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 219764 -r 127.0.0.1:19334 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /riffcashrpc>
        ProxyPass http://127.0.0.1:19764/
        ProxyPassReverse http://127.0.0.1:19764/
